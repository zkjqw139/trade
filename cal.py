# -*- coding: utf-8 -*-
"""
Created on Tue Mar 13 12:18:53 2018
...
#    args = parser.parse_args()
    stock='C:/Users/hasee/Desktop/hw1/testing_data.csv'
    action='C:/Users/hasee/Desktop/hw1/output2.csv'
    # Load stock data
    FEATURE_NAMES = ('open', 'high', 'low', 'close')
    stocks_df = pd.read_csv(stock, names=FEATURE_NAMES)

    # Load actions
    with open(action, 'r') as action_file:
        actions = list()
